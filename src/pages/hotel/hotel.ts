...
// The below will provide the data to populate the page according to the city parameter provided
...
//As there are quite a lot of variables to populate, the below function handles the proper writting

populateVariables(picture1: string,picture2:string,
    hotel:string, hotelPrice:string,hotelDescription:string,
    hotelService:string,pictureSelected:string){
...
//Once user clicks on an image, this will change the picture selected
